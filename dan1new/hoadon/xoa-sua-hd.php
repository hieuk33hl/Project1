    ...
    ?>
      <tr>
	    ...
	    <td><?php echo $hoadon["ngay"] ?></td>
		  <td><a href="../dan1/hoadon/suahd.php?ma_hd=<?php echo $hoadon["ma_hd"] ?>">Sửa</a></td>
		  <td><a href="../dan1/hoadon/xoahd.php?ma_hd=<?php echo $hoadon["ma_hd"] ?>" onclick="return confirm('Are u sure?')">Xóa</a></td>
      </tr>
    <?php
    }
    ?>
