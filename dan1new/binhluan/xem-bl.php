...
<body>
  ...
  mysqli_close($con);
  ?>
	<form action="../dan1/binhluan/xem-bl.php" method="get">
    ...
    ?>
      <tr>
        ...
        <td><?php echo $binhluan["comment"] ?></td>
		 <td><a href="../dan1/binhluan/xoabl.php?ma_bl=<?php echo $binhluan["ma_bl"] ?>" onclick="return confirm('Are u sure?')">Xóa</a></td>
      </tr>
    <?php
    }
    ?>
