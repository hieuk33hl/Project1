	...
	<form action="dangnhapad2.php" method="post">
		...
		<div id="tong">
			<div id="mid">
				<div id="form">
					<p>
						<font color="#E90003 " size="+3"><b>Tài khoản:</b></font>
					</p><input type="text" name="username" value="<?php if (isset($_COOKIE["username"])) {
																		echo $username;
																	} ?>" required><br>
					<p>
						<font color="#E90003 " size="+3"><b>Mật khẩu:</b></font>
					</p><input type="password" name="password" value="<?php if (isset($_COOKIE["password"])) {
																			echo $password;
																		} ?>" required><br><br>
